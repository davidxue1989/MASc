...
This thesis seeks to improve the state of the art prompting system, COACH, for the children with ASD population.  It investigates the feasibility of using a humanoid robot, NAO, as its prompting agent through a Wizard of Oz (WoZ) pilot study.  The WoZ study showed promising results of the robot potentially being used as an assistance to a child with ASD through hand-washing tasks.  The study also suggested parent robot joint prompting sessions as a valid method for improving child's compliance to the robot.  The important challenges faced are summarized and possible recommendations for overcoming these challenges are suggested.
...
\include{./tex/intro_chp/intro_chp}
\include{./tex/lit_rev_chp/lit_rev_chp}
\include{./tex/research_objectives_chp/research_objectives_chp}
\include{./tex/woz_chp/woz_chp}
%%\include{./tex/gaze_tracking_chp/gaze_tracking_chp}
\include{./tex/conclusion_chp/conclusion_chp}
\include{./tex/appendices/appendices_chp}
