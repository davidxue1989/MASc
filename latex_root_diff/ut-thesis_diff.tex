...
%DIF DEL C:\Users\David\Documents\GitHub\MASc\latex_root_before\ut-thesis.tex   Tue Jun 28 20:27:25 2016
%DIF ADD C:\Users\David\Documents\GitHub\MASc\latex_root\ut-thesis.tex          Mon Jun 27 19:27:41 2016
%%
...
This thesis seeks to improve the state of the art prompting system, COACH, for the children with ASD population.  It investigates the \DIFdelbegin \DIFdel{prospects }\DIFdelend \DIFaddbegin \DIFadd{feasibility }\DIFaddend of using a humanoid robot, NAO, as its prompting agent through a Wizard of Oz (WoZ) pilot study.  The WoZ study showed promising results of the robot \DIFdelbegin \DIFdel{'s ability to assist }\DIFdelend \DIFaddbegin \DIFadd{potentially being used as an assistance to }\DIFaddend a child with ASD through hand-washing tasks.  \DIFdelbegin \DIFdel{It }\DIFdelend \DIFaddbegin \DIFadd{The study }\DIFaddend also suggested parent robot joint prompting sessions as a valid method for improving child's compliance to the robot.  The important challenges faced are summarized and possible recommendations for overcoming these challenges are suggested.
...
Our overall goal is to \DIFdelbegin \DIFdel{increase a child }\DIFdelend \DIFaddbegin \DIFadd{investigate the feasibility of increasing children }\DIFaddend with ASD's engagement\DIFdelbegin \DIFdel{level }\DIFdelend \DIFaddbegin \DIFadd{, prompt compliance, and task completion }\DIFaddend during COACH prompting for hand-washing tasks\DIFdelbegin \DIFdel{, and thus improving complied prompt rate and task completion rate}\DIFdelend .  Our approach is to incorporate a half body humanoid robot, NAO T14 (see Figure \ref{fig:HalfBodyNAO}) by Aldebaran Robotics, into the current COACH setup, capable of delivering verbal and gesture prompts and attention grabbers\DIFaddbegin \DIFadd{.
}\DIFaddend %%\item to automatically track the VFOA of the child so that the robot can call out the child's name with a waving gesture or blink its LEDs for getting child's attention if the child is not looking at the robot before prompting
...
We hypothesize that \DIFaddbegin \DIFadd{through }\DIFaddend the incorporation of a humanoid robot prompting agent, such as NAO T14, \DIFdelbegin \DIFdel{would sufficiently capture and maintain }\DIFdelend \DIFaddbegin \DIFadd{we would be able to show feasibility in better capturing and maintaining }\DIFaddend children with ASD's attention during prompting and \DIFdelbegin \DIFdel{keep }\DIFdelend \DIFaddbegin \DIFadd{keeping }\DIFaddend them engaged during task execution, so that high prompt compliance rates and task completion rates would be achieved when assisting them through ADLs such as hand-washing.
...
\begin{enumerate}
	\item To investigate \DIFdelbegin \DIFdel{if }\DIFdelend \DIFaddbegin \DIFadd{the feasibility of }\DIFaddend a prompting system using NAO \DIFdelbegin \DIFdel{is able }\DIFdelend to guide a child with ASD through hand-washing, and identify factors for improvement
...
\begin{enumerate}
	\item The humanoid robot, NAO, is able to \DIFdelbegin \DIFdel{independently assist }\DIFdelend \DIFaddbegin \DIFadd{demonstrate preliminary success in independently assisting }\DIFaddend child with ASD through hand-washing, and \DIFdelbegin \DIFdel{child exhibits greater }\DIFdelend \DIFaddbegin \DIFadd{the child exhibits similar }\DIFaddend engagement level, \DIFdelbegin \DIFdel{higher }\DIFdelend complied prompt rate, and \DIFdelbegin \DIFdel{better }\DIFdelend task completion when prompted by NAO \DIFdelbegin \DIFdel{than }\DIFdelend \DIFaddbegin \DIFadd{as compared to when prompted }\DIFaddend by parent.
...
One major objective of this thesis is to investigate the \DIFdelbegin \DIFdel{impacts that }\DIFdelend \DIFaddbegin \DIFadd{feasibility of }\DIFaddend using a humanoid prompting agent \DIFdelbegin \DIFdel{has on }\DIFdelend \DIFaddbegin \DIFadd{in increasing }\DIFaddend engagement, prompt compliance and task performance of children with ASD during hand-washing activities.  This is the first research of its kind in the field of humanoid robot prompting agent guiding children with ASD through an activity of daily living.  Therefore, it is wise to begin with a pilot study, the purpose of which is to show plausibility of the key underlying assumptions of our hypotheses, to create design recommendations of the robot for future studies, and to probe what questions are important to be answered later in a more rigorous randomized control trial.  For these reasons, the pilot study should be exploratory in nature, having a flexible experimental design, and a relatively low experiment setup cost\DIFaddbegin \DIFadd{, focusing on feasibility testing}\DIFaddend .  A Wizard of Oz experimental design in a case study format is appropriate.
...
One more limitation existed in our experiment protocol, specifically in regulating how the parent prompts in Phase C.  During Phase C, where the parent prompts the child alongside the robot, we gave the parent freedoms to decide how best to prompt.  Firstly, the parent could choose between verbal prompting in competition with the robot prompts, verbal prompting complementary to robot prompts, and physical prompting complementary to robot prompts\DIFdelbegin %DIFDELCMD < [%%%
\DIFdel{sec ref}%DIFDELCMD < ]%%%
...
\DIFdelbegin \DIFdel{Because of the preliminary nature of our study, the results were not significant.  However, through }\DIFdelend \DIFaddbegin \DIFadd{This study focuses on investigating the feasibility of the robot as a prompting agent in better engaging the child during hand-washing.  Through }\DIFaddend conducting the study, we have learned some of the challenges we must face to \DIFdelbegin \DIFdel{succeed in studies of this sort and }\DIFdelend \DIFaddbegin \DIFadd{continue along this research direction.  We also }\DIFaddend gained some insights on how to solve these challenges.  We here summarize the challenges met and their recommendations.
...
\DIFaddbegin \bibitem{amberg2008expression}
\DIFadd{Brian Amberg, Reinhard Knothe, and Thomas Vetter.
}\newblock \DIFadd{Expression invariant 3d face recognition with a morphable model.
}\newblock \DIFadd{In }{\em \DIFadd{Automatic Face \& Gesture Recognition, 2008. FG'08. 8th IEEE
  International Conference on}}\DIFadd{, pages 1--6. IEEE, 2008.
}

\DIFaddend \bibitem{ashton2001applications}
Tamarah~M Ashton.
\newblock The applications of aba to technology: The discrete trial trainer.
\newblock {\em Journal of Special Education Technology}, 16(1):41, 2001.
...
\DIFaddbegin \bibitem{baluja1994non}
\DIFadd{Shumeet Baluja and Dean Pomerleau.
}\newblock \DIFadd{Non-intrusive gaze tracking using artificial neural networks.
}\newblock \DIFadd{Technical report, DTIC Document, 1994.
}

\DIFaddend \bibitem{bandura1969principles}
Albert Bandura.
...
\DIFaddbegin \bibitem{belkin2003laplacian}
\DIFadd{Mikhail Belkin and Partha Niyogi.
}\newblock \DIFadd{Laplacian eigenmaps for dimensionality reduction and data
  representation.
}\newblock {\em \DIFadd{Neural computation}}\DIFadd{, 15(6):1373--1396, 2003.
}

\DIFaddend \bibitem{bellini2007meta}
...
\newblock {\em Journal of Autism and Developmental Disorders}, 30(6):569--583,
  2000.
...
\DIFaddbegin \bibitem{colombo1999real}
\DIFadd{Carlo Colombo and Alberto Del~Bimbo.
}\newblock \DIFadd{Real-time head tracking from the deformation of eye contours using a
  piecewise affine camera.
}\newblock {\em \DIFadd{Pattern Recognition Letters}}\DIFadd{, 20(7):721--730, 1999.
}

\DIFaddend \bibitem{congress1997individuals}
US~Congress.
\newblock Individuals with disabilities education act amendments of 1997.
\newblock In {\em Washington, DC: US Congress}, 1997.
...
\bibitem{eldevik2009meta}
Sigmund Eldevik, Richard~P Hastings, J~Carl Hughes, Erik Jahr, Svein Eikeseth,
  and Scott Cross.
\newblock Meta-analysis of early intensive behavioral intervention for children
  with autism.
\newblock {\em Journal of Clinical Child \& Adolescent Psychology},
  38(3):439--450, 2009.

\bibitem{farley2009twenty}
Megan~A Farley, William~M McMahon, Eric Fombonne, William~R Jenson, Judith
  Miller, Michael Gardner, Heidi Block, Carmen~B Pingree, Edward~R Ritvo,
  Riva~Arielle Ritvo, et~al.
\newblock Twenty-year outcome for individuals with autism and average or
  near-average cognitive abilities.
\newblock {\em Autism Research}, 2(2):109--118, 2009.
...
\DIFaddbegin \bibitem{funes2012gaze}
\DIFadd{Kenneth~Alberto Funes~Mora and J~Odobez.
}\newblock \DIFadd{Gaze estimation from multimodal kinect data.
}\newblock \DIFadd{In }{\em \DIFadd{Computer Vision and Pattern Recognition Workshops (CVPRW),
  2012 IEEE Computer Society Conference on}}\DIFadd{, pages 25--30. IEEE, 2012.
}

\bibitem{funes2013person}
\DIFadd{Kenneth~Alberto Funes~Mora and Jean-Marc Odobez.
}\newblock \DIFadd{Person independent 3d gaze estimation from remote rgb-d cameras.
}\newblock \DIFadd{In }{\em \DIFadd{International Conference on Image Processing}}\DIFadd{, number
  EPFL-CONF-192423. IEEE, 2013.
}

\DIFaddend \bibitem{ganz2012meta}
...
\DIFaddbegin \bibitem{hansen2010eye}
\DIFadd{Dan~Witzner Hansen and Qiang Ji.
}\newblock \DIFadd{In the eye of the beholder: A survey of models for eyes and gaze.
}\newblock {\em \DIFadd{Pattern Analysis and Machine Intelligence, IEEE Transactions
  on}}\DIFadd{, 32(3):478--500, 2010.
}

\DIFaddend \bibitem{heimann1995increasing}
...
\newblock {\em Advances in health sciences education}, 9(3):241--249, 2004.
...
\newblock {\em Research in developmental disabilities}, 26(4):359--383, 2005.
...
\bibitem{keenan2014autism}
Mickey Keenan, Karola Dillenburger, Hanns~R{\"u}diger R{\"o}ttgers, Katerina
  Dounavi, Sigr{\'\i}tur~L{\'o}a J{\'o}nsd{\'o}ttir, Paolo Moderato,
  Jacqueline~JAM Schenk, Javier Viru{\'e}s-Ortega, Lise Roll-Pettersson, and
  Neil Martin.
\newblock Autism and aba: The gulf between north america and europe.
\newblock {\em Review Journal of Autism and Developmental Disorders},
  2(2):167--183, 2014.

\bibitem{koegel2003teaching}
Lynn~Kern Koegel, Cynthia~M Carter, and Robert~L Koegel.
\newblock Teaching children with autism self-initiations as a pivotal response.
\newblock {\em Topics in Language Disorders}, 23(2):134--145, 2003.
...
\DIFaddbegin \bibitem{kruger2002gabor}
\DIFadd{Volker Kr}{\DIFadd{\"u}}\DIFadd{ger and Gerald Sommer.
}\newblock \DIFadd{Gabor wavelet networks for efficient head pose estimation.
}\newblock {\em \DIFadd{Image and vision computing}}\DIFadd{, 20(9):665--672, 2002.
}

\DIFaddend \bibitem{lang2014assistive}
...
\bibitem{lathan2007using}
Corinna Lathan, Katharina Boser, Charlotte Safos, Cathy Frentz, and Kaitlin
  Powers.
\newblock Using cosmo’s learning system (cls) with children with autism.
\newblock In {\em Proceedings of the International Conference on
  Technology-Based Learning with Disabilities}, pages 37--47. Citeseer, 2007.

\DIFaddbegin \bibitem{li2000support}
\DIFadd{Yongmin Li, Shaogang Gong, and Heather Liddell.
}\newblock \DIFadd{Support vector regression and classification based multi-view face
  detection and recognition.
}\newblock \DIFadd{In }{\em \DIFadd{Automatic Face and Gesture Recognition, 2000. Proceedings.
  Fourth IEEE International Conference on}}\DIFadd{, pages 300--305. IEEE, 2000.
}

\DIFaddend \bibitem{liss2001predictors}
...
\DIFaddbegin \bibitem{lu2011inferring}
\DIFadd{Feng Lu, Yusuke Sugano, Takahiro Okabe, and Yoichi Sato.
}\newblock \DIFadd{Inferring human gaze from appearance via adaptive linear regression.
}\newblock \DIFadd{In }{\em \DIFadd{Computer Vision (ICCV), 2011 IEEE International Conference
  on}}\DIFadd{, pages 153--160. IEEE, 2011.
}

\DIFaddend \bibitem{massaro2006read}
...
\bibitem{mcgee1986extension}
Gail~G McGee, Patricia~J Krantz, and Lynn~E McClannahan.
\newblock An extension of incidental teaching procedures to reading instruction
  for autistic children.
\newblock {\em Journal of Applied Behavior Analysis}, 19(2):147--157, 1986.
...
\DIFaddbegin \bibitem{murphy2009head}
\DIFadd{Erik Murphy-Chutorian and Mohan~M Trivedi.
}\newblock \DIFadd{Head pose estimation in computer vision: A survey.
}\newblock {\em \DIFadd{Pattern Analysis and Machine Intelligence, IEEE Transactions
  on}}\DIFadd{, 31(4):607--626, 2009.
}

\bibitem{newcombe2011kinectfusion}
\DIFadd{Richard~A Newcombe, Shahram Izadi, Otmar Hilliges, David Molyneaux, David Kim,
  Andrew~J Davison, Pushmeet Kohi, Jamie Shotton, Steve Hodges, and Andrew
  Fitzgibbon.
}\newblock \DIFadd{Kinectfusion: Real-time dense surface mapping and tracking.
}\newblock \DIFadd{In }{\em \DIFadd{Mixed and augmented reality (ISMAR), 2011 10th IEEE
  international symposium on}}\DIFadd{, pages 127--136. IEEE, 2011.
}

\DIFaddend \bibitem{palmen2013behavioral}
Anna Maria Josephina~Wilhelmina Palmen.
\newblock {\em Behavioral interventions in adolescents and young adults with
  high-functioning ASD: Improvement, generalization, and maintenance of
  adaptive skills}.
\newblock UB Nijmegen [Host], 2013.
...
\DIFaddbegin \bibitem{paysan20093d}
\DIFadd{Pascal Paysan, Reinhard Knothe, Brian Amberg, Sami Romdhani, and Thomas Vetter.
}\newblock \DIFadd{A 3d face model for pose and illumination invariant face recognition.
}\newblock \DIFadd{In }{\em \DIFadd{Advanced Video and Signal Based Surveillance, 2009. AVSS'09.
  Sixth IEEE International Conference On}}\DIFadd{, pages 296--301. IEEE, 2009.
}

\DIFaddend \bibitem{peters2011meta}
...
\newblock {\em Research in Autism Spectrum Disorders}, 5(1):60--69, 2011.
...
\bibitem{rajendran2007cognitive}
Gnanathusharan Rajendran and Peter Mitchell.
\newblock Cognitive theories of autism.
\newblock {\em Developmental Review}, 27(2):224--260, 2007.
...
\DIFaddbegin \bibitem{raytchev2004head}
\DIFadd{Bisser Raytchev, Ikushi Yoda, and Katsuhiko Sakaue.
}\newblock \DIFadd{Head pose estimation by nonlinear manifold learning.
}\newblock \DIFadd{In }{\em \DIFadd{Pattern Recognition, 2004. ICPR 2004. Proceedings of the 17th
  International Conference on}}\DIFadd{, volume~4, pages 462--466. IEEE, 2004.
}

\DIFaddend \bibitem{reichow2009comprehensive}
Brian Reichow and Mark Wolery.
\newblock Comprehensive synthesis of early intensive behavioral interventions
  for young children with autism based on the ucla young autism project model.
\newblock {\em Journal of autism and developmental disorders}, 39(1):23--41,
  2009.

\DIFaddbegin \bibitem{reinders1996locating}
\DIFadd{Marcel~JT Reinders, RWC Koch, and Jan~J Gerbrands.
}\newblock \DIFadd{Locating facial features in image sequences using neural networks.
}\newblock \DIFadd{In }{\em \DIFadd{Automatic Face and Gesture Recognition, 1996., Proceedings of
  the Second International Conference on}}\DIFadd{, pages 230--235. IEEE, 1996.
}

\DIFaddend \bibitem{robins2009isolation}
...
\DIFaddbegin \bibitem{roweis2000nonlinear}
\DIFadd{Sam~T Roweis and Lawrence~K Saul.
}\newblock \DIFadd{Nonlinear dimensionality reduction by locally linear embedding.
}\newblock {\em \DIFadd{Science}}\DIFadd{, 290(5500):2323--2326, 2000.
}

\DIFaddend \bibitem{sallows2005intensive}
...
\DIFaddbegin \bibitem{sirohey2001eye}
\DIFadd{Saad~A Sirohey and Azriel Rosenfeld.
}\newblock \DIFadd{Eye detection in a face image using linear and nonlinear filters.
}\newblock {\em \DIFadd{Pattern recognition}}\DIFadd{, 34(7):1367--1391, 2001.
}

\DIFaddend \bibitem{smith2012developmental}
...
\bibitem{sparrow2005vineland}
S~Sparrow, D~Cicchetti, and D~Balla.
\newblock Vineland-ii.
\newblock {\em Vineland adaptive behavior scales. Survey forms manual.
  Minneapolis: NCS Pearson Inc}, 2005.
...
\bibitem{teunisse2007cognitieve}
...
\newblock {\em Tijdschrift voor Psychiatrie}, 2007.
...
\newblock {\em Paladyn, Journal of Behavioral Robotics}, 3(4):209--217, 2012.
...
\DIFaddbegin \bibitem{torta2012can}
\DIFadd{Elena Torta, Jim van Heumen, Raymond~H Cuijpers, and James~F Juola.
}\newblock \DIFadd{How can a robot attract the attention of its human partner? a
  comparative study over different modalities for attracting attention.
}\newblock \DIFadd{In }{\em \DIFadd{Social robotics}}\DIFadd{, pages 288--297. Springer, 2012.
}

\bibitem{valenti2008accurate}
\DIFadd{Roberto Valenti and Theo Gevers.
}\newblock \DIFadd{Accurate eye center location and tracking using isophote curvature.
}\newblock \DIFadd{In }{\em \DIFadd{Computer Vision and Pattern Recognition, 2008. CVPR 2008.
  IEEE Conference on}}\DIFadd{, pages 1--8. IEEE, 2008.
}

\bibitem{valenti2012combining}
\DIFadd{Roberto Valenti, Nicu Sebe, and Theo Gevers.
}\newblock \DIFadd{Combining head pose and eye location information for gaze estimation.
}\newblock {\em \DIFadd{Image Processing, IEEE Transactions on}}\DIFadd{, 21(2):802--815, 2012.
}

\DIFaddend \bibitem{van2011assessing}
...
\DIFaddbegin \bibitem{voit2008head}
\DIFadd{Michael Voit, Kai Nickel, and Rainer Stiefelhagen.
}\newblock \DIFadd{Head pose estimation in single-and multi-view environments-results on
  the clear’07 benchmarks.
}\newblock \DIFadd{In }{\em \DIFadd{Multimodal Technologies for Perception of Humans}}\DIFadd{, pages
  307--316. Springer, 2008.
}

\DIFaddend \bibitem{volkmar2005handbook}
...
\DIFaddbegin \bibitem{wang2007enhancement}
\DIFadd{Jian-Gang Wang and Eric Sung.
}\newblock \DIFadd{Em enhancement of 3d head pose estimated by point at infinity.
}\newblock {\em \DIFadd{Image and Vision Computing}}\DIFadd{, 25(12):1864--1874, 2007.
}

\DIFaddend \bibitem{weitz1997aac}
...
Christina Whalen, Debbie Moss, Aaron~B Ilan, Manya Vaupel, Paul Fielding, Kevin
  Macdonald, Shannon Cernich, and Jennifer Symon.
\newblock Efficacy of teachtown: Basics computer-assisted intervention for the
  intensive comprehensive autism program in los angeles unified school
  district.
\newblock {\em Autism}, 14(3):179--197, 2010.
...
\DIFadd{Jing Xiao, Simon Baker, Iain Matthews, and Takeo Kanade.
}\newblock \DIFadd{Real-time combined 2d+ 3d active appearance models.
}\newblock \DIFadd{In }{\em \DIFadd{CVPR (2)}}\DIFadd{, pages 535--542, 2004.
}\DIFaddend 
