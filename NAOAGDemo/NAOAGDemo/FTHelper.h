...
typedef void (*FTHelperCallBackTrackLost)(PVOID lpParam);
...
public:
	...
	HRESULT Init(HWND hWnd, FTHelperCallBack callBack, PVOID callBackParam, FTHelperCallBackTrackLost callBackTrackLost, PVOID callBackTrackLostParam,
...
private:
	...
	FTHelperCallBackTrackLost	m_CallBackTrackLost;
	LPVOID                      m_CallBackTrackLostParam;
	float                       m_XCenterFace;
	float                       m_YCenterFace;
